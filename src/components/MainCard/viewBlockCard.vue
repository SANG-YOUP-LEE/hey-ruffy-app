  ...
  <div :class="['routine_block', cls]">
    <div class="rb_head">
      ...
      <div class="actions">
        ...
        <button class="p_white sm" @click="expanded = !expanded">{{ expanded ? '접기' : '더 보기' }}</button>
    ...
    <div class="rb_body" v-if="expanded">
      ...
      <div class="walk_check" v-if="flags.hasWalkResolved">
        <button class="p_white" @click="actions.openWalkPopup">산책 현황 보기</button>
      </div>
    </div>
  </div>
</template>
