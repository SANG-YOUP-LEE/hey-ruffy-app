...
watchEffect(() => { mv.setScrolled(scrolledRef.value); mv.setHeaderShort(headerShortRef.value); mv.setLoading(rStore.isLoading); mv.setFetched(rStore.hasFetched); update() })
</script>